define(function(require, exports, module) {
    ...
    function PurchasedPassView(options, data) {
        View.apply(this, arguments);
        // console.log("data inside PurchasedPassView.js", this.options.data)
        // console.log("# of days inside PurchasedPassView.js", window.gymDays)
    ...
    function _createHeader(){
        this.headerBackground = new ContainerSurface({
            classes: ["PurchasedPassView-header"],
            size: [undefined, 55], 
            properties: {
        ...
        this.PurchasedPassView = new Surface({
            classes: ["PurchasedPassView-text"],
        ...
        this.PurchasedPassViewMod = new StateModifier({
            origin: [0.5,0.5]
        });
        ...
        this.headerBackground.add(this.PurchasedPassViewMod).add(this.PurchasedPassView);
    ...
    function _createBody() {
        this.bodyBackground = new ContainerSurface({
            classes: ["PurchasedPassView-body"],
   ...
   PurchasedPassView.prototype.moveUp = function(){
    ...
    PurchasedPassView.prototype.moveDown = function(){
        this.layoutModifier.setTransform(
